...
describe("schedule", function () {
  ...
  test(`schedule. Onetime validation`, function (browser) {
    browser
      ...
      .assert.cssClassPresent(
        `table.mx-table td[title="${dayjs()
          .add(-1, "day")
          .format("YYYY-MM-DD")}"]`,
        "cell disabled"
      )
      .assert.not.cssClassPresent(
        `table.mx-table td[title="${dayjs().format("YYYY-MM-DD")}"]`,
        "cell disabled"
      )
  ...
  test(`schedule. Daily once and periodical validation. Endless and end schedule`, function (browser) {
    browser
      ...
      //Duration
      .assert.cssClassPresent(
        'div[qa-data="schedule-dialog-start-date-time"]',
        "custom-warning-inline"
      )
      .assert.containsText(
        'p[qa-data="schedule-start-date-time-error"]',
        "can not be empty"
      )
      //Daily
      .assert.cssClassPresent(
        'input[qa-data="schedule-dialog-eachnday"]',
        "input is-danger"
      )
      .assert.containsText(
        'p[qa-data="schedule-dialog-eachnday-error"]',
        "can not be empty"
      )
      //Once
      .assert.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-once"]',
        "custom-warning"
      )
      .assert.containsText(
        'p[qa-data="schedule-daily-frequency-once-error"]',
        "can not be empty"
      )
      //Create button
      .assert.cssClassPresent(
      ...
      //Duration
      .setValue(
        'div[qa-data="schedule-dialog-start-date-time"] input',
        dayjs(testJob.schedules[1].startDateTime).format("YYYY-MM-DD HH:mm:ss")
      )
      .click('[qa-data="schedule-name"]')
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-dialog-start-date-time"]',
      ...
      //Once
      .setValue(
        'div[qa-data="schedule-daily-frequency-once"] input',
        testJob.schedules[1].dailyFrequency.occursOnceAt
      )
      .click('[qa-data="schedule-name"]')
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-once"]',
      ...
      .assert.cssClassPresent(
        'div[qa-data="schedule-dialog-end-date-time"]',
        "custom-warning-inline"
      )
      .assert.containsText(
        'p[qa-data="schedule-end-date-time-error"]',
        "can not be empty"
      )
      .setValue(
        'div[qa-data="schedule-dialog-end-date-time"] input',
        dayjs(testJob.schedules[1].endDateTime).format("YYYY-MM-DD HH:mm:ss")
      )
      .click('[qa-data="schedule-name"]')
      //Warning removed
      .assert.not.cssClassPresent(
      ...
      .assert.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-start"]',
        "custom-warning-inline"
      )
      .assert.containsText(
        'p[qa-data="schedule-occurs-every-start-error"]',
        "can not be empty"
      )
      .assert.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-end"]',
        "custom-warning-inline"
      )
      .assert.containsText(
        'p[qa-data="schedule-occurs-every-end-error"]',
        "can not be empty"
      )
      .assert.cssClassPresent(
        'input[qa-data="schedule-daily-frequency-interval"]',
        "input is-danger"
      )
      .assert.containsText(
        'p[qa-data="schedule-every-error"]',
        "can not be empty"
      )
      .assert.cssClassPresent(
        'button[qa-data="schedule-save"]',
      ...
      .setValue(
        'div[qa-data="schedule-daily-frequency-start"] input',
        testJob.schedules[2].dailyFrequency.start
      )
      .click('[qa-data="schedule-name"]')
      .setValue(
        'div[qa-data="schedule-daily-frequency-end"] input',
        testJob.schedules[2].dailyFrequency.end
      )
      .click('[qa-data="schedule-name"]')
      .setValue(
        'input[qa-data="schedule-daily-frequency-interval"]',
        testJob.schedules[2].dailyFrequency.occursEvery.intervalValue
      )
      //Warning removed
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-start"]',
  ...
  test(`schedule. Weekly validation.`, function (browser) {
    browser
      ...
      //Weekly
      .assert.cssClassPresent(
        'input[qa-data="schedule-dialog-eachnweek"]',
        "input is-danger"
      )
      .assert.containsText(
        'p[qa-data="schedule-eachnweek-error"]',
        "can not be empty"
      )
      .assert.cssClassPresent(
        'div[qa-data="schedule-dialog-weekday"] button#sunday',
        "is-danger"
      )
      .assert.containsText(
        'p[qa-data="schedule-weekdays-error"]',
        "at least 1 day of week"
      )
      //Once
      .assert.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-once"]',
      ...
      .setValue(
        'div[qa-data="schedule-dialog-start-date-time"] input',
        dayjs(testJob.schedules[4].startDateTime).format("YYYY-MM-DD HH:mm:ss")
      )
      .click('[qa-data="schedule-name"]')
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-dialog-start-date-time"]',
      ...
      .assert.cssClassPresent(
        'div[qa-data="schedule-dialog-weekday"] button#monday',
        "is-info"
      )
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-dialog-weekday"] button#sunday',
      ...
      .setValue(
        'div[qa-data="schedule-daily-frequency-once"] input',
        testJob.schedules[4].dailyFrequency.occursOnceAt
      )
      .click('[qa-data="schedule-name"]')
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-once"]',
  ...
  test(`schedule. Monthly validation.`, function (browser) {
    browser
      ...
      //Monthly
      .assert.cssClassPresent(
        'div[qa-data="schedule-months"] button#january',
        "button is-danger"
      )
      .assert.containsText('p[qa-data="schedule-months-error"]', "at least 1")
      .assert.cssClassPresent(
        'input[qa-data="schedule-month-days"]',
        "is-danger"
      )
      .assert.containsText(
        'p[qa-data="schedule-monthdays-error"]',
      ...
      .setValue(
        'div[qa-data="schedule-dialog-start-date-time"] input',
        dayjs(testJob.schedules[5].startDateTime).format("YYYY-MM-DD HH:mm:ss")
      )
      .click('[qa-data="schedule-name"]')
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-dialog-start-date-time"]',
      ...
      .assert.not.containsText(
        'p[qa-data="schedule-months-error"]',
        "at least 1"
      )
      //Month days
      .setValue(
        'input[qa-data="schedule-month-days"]',
        testJob.schedules[5].day.reduce(
      ...
      .setValue(
        'div[qa-data="schedule-daily-frequency-once"] input',
        testJob.schedules[5].dailyFrequency.occursOnceAt
      )
      .click('[qa-data="schedule-name"]')
      .assert.not.cssClassPresent(
        'div[qa-data="schedule-daily-frequency-once"]',
      ...
      .assert.cssClassPresent(
        'div[qa-data="schedule-months"] button#december',
        "is-info"
      )
      .assert.cssClassPresent(
        'div[qa-data="schedule-months"] button#july',
        "is-info"
      )
      //No warnings
      .assert.not.cssClassPresent(
  ...
  test(`schedule. Duration limitations: startDate, endDate, recurrence starting and till`, function (browser) {
    browser
      ...
      .assert.not.cssClassPresent(
        `table.mx-table td[title="${dayjs(testJob.schedules[1].startDateTime)
          .add(1, "day")
          .format("YYYY-MM-DD")}"]`,
        "cell disabled"
      )
      ...
      .assert.not.cssClassPresent(
        `table.mx-table td[title="${dayjs(testJob.schedules[1].endDateTime)
          .add(0, "day")
          .format("YYYY-MM-DD")}"]`,
        "cell disabled"
      )
      ...
      .assert.cssClassPresent(
        `div.mx-time-content ul[data-type="hour"] li[data-index="${
          parseInt(
            testJob.schedules[2].dailyFrequency.start.split(":")[0],
            10
          ) - 1
        }"]`,
        "mx-time-item disabled"
      ...
      .assert.not.cssClassPresent(
        `div.mx-time-content ul[data-type="hour"] li[data-index="${parseInt(
          testJob.schedules[2].dailyFrequency.start.split(":")[0],
          10
        )}"]`,
        "mx-time-item disabled"
