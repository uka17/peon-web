<template>
  <div class="field">
    ...
    <div class="field has-addons">
      ...
      <p class="control">
        <input
          id="schedule-eachnday"
          type="text"
          qa-data="schedule-dialog-eachnday"
          v-bind:class="{
            'is-danger':
              fieldIsValid(
                'eachNDay',
                { 'eachNDay': eachNDayValue },
                dailyConstraints
              ) !== '',
          }"
          maxlength="3"
          @keypress="isNumber($event)"
          v-model.number="eachNDayValue"
          class="input"
        />
      </p>
      <p class="control">
    ...
    <p
      id="schedule-eachnday-error"
      qa-data="schedule-dialog-eachnday-error"
