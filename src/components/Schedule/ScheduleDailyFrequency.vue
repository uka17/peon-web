<template>
  <div>
      ...
      <div class="control">
        ...
        <label class="radio">
          <input
            type="radio"
            name="every"
            qa-data="schedule-daily-periodical"
            v-bind:value="true"
            v-model="everyValue"
          />
          Periodicaly
    ...
    <div class="field" v-bind:class="{ 'is-hidden': everyValue }">
      ...
      <div
        class="control"
        qa-data="schedule-daily-frequency-once"
        v-bind:class="{
          'custom-warning':
            fieldIsValid(
              'occursOnceAt',
              dailyFrequency,
              occursOnceAtConstraints
            ) !== '',
        }"
      >
        <date-time-picker
      ...
      <p
        id="schedule-occursonceat-error"
        qa-data="schedule-daily-frequency-once-error"
        class="help is-danger"
      >
        {{
          fieldIsValid("occursOnceAt", dailyFrequency, occursOnceAtConstraints)
        }}
      </p>
    </div>
    <div v-bind:class="{ 'is-hidden': !everyValue }">
      ...
      <div class="field has-addons">
        <p class="control">
          <a class="button is-static"> Starting </a>
        </p>
        <div
          qa-data="schedule-daily-frequency-start"
          v-bind:class="{
            'custom-warning-inline':
              fieldIsValid('start', dailyFrequency, everyConstraints) !== '',
          }"
        >
        ...
        <p class="control">
          <a class="button is-static"> till </a>
        </p>
        <div
          qa-data="schedule-daily-frequency-end"
          v-bind:class="{
            'custom-warning-inline':
              fieldIsValid('end', dailyFrequency, everyConstraints) !== '',
          }"
        >
          <p class="control date-time-picker">
            <date-time-picker
        ...
        <p class="control">
          <input
            ...
            qa-data="schedule-daily-frequency-interval"
            maxlength="3"
            ...
            v-bind:class="{
              'is-danger':
                fieldIsValid(
                  ...
                  intervalValueConstraints
                ) !== '',
            }"
            v-model.number="dailyFrequency.occursEvery.intervalValue"
            class="input"
          />
        </p>
        <p class="control">
      ...
      <p
        id="schedule-occurs-every-start-error"
        qa-data="schedule-occurs-every-start-error"
        class="help is-danger"
      >
        {{ fieldIsValid("start", dailyFrequency, everyConstraints) }}
      </p>
      <p
        id="schedule-occurs-every-end-error"
        qa-data="schedule-occurs-every-end-error"
        class="help is-danger"
      >
        {{ fieldIsValid("end", dailyFrequency, everyConstraints) }}
      </p>
      <p
        id="schedule-every-error"
        qa-data="schedule-every-error"
        class="help is-danger"
      >
        {{
          fieldIsValid(
...
export default {
  ...
  methods: {
    isLaterThanEnd(time) {
      if (this.dailyFrequency.end === "") return false;
    ...
    isEarlierThanStart(time) {
      if (this.dailyFrequency.start === "") return false;
  ...
  watch: {
    eachNDayValue: function () {
      this.$emit("schedule-daily-frequency-update", {
        value: this.dailyFrequency,
      });
    },
  },
  computed: {
    everyValue: {
      ...
      set(newValue) {
        this.$emit("schedule-daily-frequency-every-update", {
          value: newValue,
        });
      },
    },
