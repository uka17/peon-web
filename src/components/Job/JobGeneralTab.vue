  ...
  <div id="job-general">
    <div class="field">
      ...
      <div class="control">
        <input
          v-model="job.name"
          id="job-dialog-name"
          qa-data="job-dialog-name"
          class="input"
          v-bind:class="{ 'is-danger': jobFieldIsValid('name') !== '' }"
          type="text"
          placeholder="Job name"
        />
      </div>
      <p id="job-dialog-name-error" class="help is-danger">
        {{ jobFieldIsValid("name") }}
      </p>
    </div>
    <div class="field">
      <div class="control">
    ...
    <div class="field">
      ...
      <div class="control">
        <textarea
          class="textarea"
          id="job-dialog-description"
          qa-data="job-dialog-description"
    ...
    <div class="columns">
          ...
          <div class="control">
            <div v-if="jobRecord.lastRunResult != null">
              <span v-if="jobRecord.lastRunResult" class="tag is-success">
                {{ formatDateTime(jobRecord.lastRunOn) }}&nbsp;<i
      ...
      <div class="column">
        <div class="field">
          <label class="label"
            >Created by
            <span class="tag">{{ jobRecord.createdBy }}</span></label
          >
          <div class="control">
            <span class="is-small"
              >{{ formatDateTime(jobRecord.createdOn) }}
            </span>
          </div>
        </div>
      </div>
      <div class="column">
        <div class="field">
          <label class="label"
            >Modified by
            <span class="tag">{{ jobRecord.modifiedBy }}</span></label
          >
          <div class="control">
