...
module.exports = [
  {
    name: "description",
    title: "",
    dataClass: "_description",
    callback: utils.helpers.info,
  },
  ...
  },
  {
    ...
    sortField: "last_run_result",
    dataClass: "has-text-centered default-cursor",
    title: "Last run",
    callback: utils.helpers.runResult,
  },
  {
    name: "last_run_on",
    sortField: "last_run_on",
    dataClass: "default-cursor",
    title: "Last run on",
    callback: utils.helpers.formatDateTime,
  },
  {
    name: "next_run",
    sortField: "next_run",
  ...
  {
    name: "step_count",
    sortField: "step_count",
    dataClass: "has-text-right default-cursor",
    title: "Steps",
  },
  {
    name: "schedule_count",
    sortField: "schedule_count",
    dataClass: "has-text-right default-cursor",
    title: "Schedules",
  },
  {
