  ...
  <div>
    ...
    <div class="columns">
      ...
      <div class="column">
        <p class="control">
          <button
            qa-data="job-list-delete-modal-show"
    ...
    <div class="columns">
      <div class="column is-paddingless">
        <vuetable-pagination-info
          qa-data="job-list-pagination-info"
          ref="jobListPaginationInfo"
        ></vuetable-pagination-info>
      </div>
      <div class="column">
        <vuetable-pagination
          qa-data="job-list-pagination"
          ref="jobListPagination"
    ...
    >
            ...
            <div class="content">
              <article class="message is-danger">
                <div class="message-body">
                  ...
                  <span qa-data="job-delete-modal-job-name"
                    ><b>{{ selectedJobName }}</b></span
                  >
                  to confirm.<br /><br />
                  <div class="field has-addons">
                    <div class="control">
                      <input
                        class="input"
                        qa-data="job-delete-modal-text"
                        v-model="jobNameToDelete"
                        type="text"
                    ...
                    <div class="control">
                      <a
                        ...
                        qa-data="job-delete-modal-confirm"
                        :disabled="deleteLocked"
                        @click="executeJobDeletion"
                      >
                        Delete
                      </a>
                    </div>
      ...
      <button
        ...
        qa-data="job-delete-modal-close"
        aria-label="close"
...
export default {
  ...
  methods: {
    onFilterReset() {
      this.moreParams = {};
      if (this.$refs.jobList) Vue.nextTick(() => this.$refs.jobList.refresh());
    },
