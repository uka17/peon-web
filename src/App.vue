<template>
  <div id="main">
    <div class="columns">
      <div class="column is-narrow" style="width: 220px">
        <aside class="menu">
          <ul class="menu-list">
            <li>
              <p class="menu-label" is-active><br />General</p>
            </li>
            ...
            <li>
              <p class="menu-label"><br />Configuration</p>
            </li>
    ...
    <div
      class="modal"
      v-bind:class="{ 'is-active': this.erorrMessage !== null }"
    >
